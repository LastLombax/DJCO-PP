...
public class SkillTreeScript : MonoBehaviour
{
    ...
    public void UpdateDescription(string buffID)
    {
        if(buffID.Equals("none"))
        {
            skillNodeDescription.GetComponent<Text>().text = "";
            return;
        }
        skillNodeDescription.GetComponent<Text>().text = nodes[buffID].GetDescription();
    }
}
...
public class SkillTreeNode
{
    ...
    public SkillTreeNode(string id, int xpPrice, int upgradeType, float value, string description)
    {
